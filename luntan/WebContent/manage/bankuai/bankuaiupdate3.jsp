...
function checkform()
{
	...
	if (document.getElementById('bankuaimingid').value=="")
	{
		alert("板块名不能为空");
		return false;
	}
...
<TABLE cellSpacing=0 cellPadding=0 width="80%" align=center border=1>
    ...
    <TR height=>
    <TD align="center" >板块图片:</TD>
    <TD align="center"> 

  <img src="<%=basePath %>uploadfile/${bean.bankuaiimagePath }" width="200" height="200"/>
 
    </TD>
    </TR>
    
    <TR height=>
    <TD align="center" >板块简介:</TD>
    <TD align="center">  <textarea class="InputCss" rows="7" cols="50" name="info" readonly="readonly">${bean.info }</textarea>
