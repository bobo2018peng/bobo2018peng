...
<a href="${url2 }add.action"><span style="font-size: 15px;font-weight: bold;">添加新板块</span></a>
板块名：<input name="bankuaiming" type="text"  value="${bankuaiming }">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1>
  	...
  	<TR >
    <TD align="center" >板块名</TD>
    <TD align="center" >板块管理员</TD>
    ...
    <TR >
    <TD align="center" >${bean.bankuaiming }</TD>
     <TD align="center" >${bean.guanli.username }</TD>

    <TD align="center"> 
    <a href="${url2 }update5.action?id=${bean.id }">指定板块管理员</a> &nbsp; &nbsp; &nbsp;
